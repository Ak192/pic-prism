  ...
  return (
      <div className="navbar sticky top-0 z-10 bg-white border-b bg-opacity-30 border-gray-200 backdrop-filter backdrop-blur-lg">
        ...
        <div className="navbar-end">
          ...
          <button className="btn btn-sm mx-2" onClick={() => document.getElementById('signup').showModal()}> Signup </button>
          <dialog id="signup" className="modal backdrop-filter backdrop-blur-sm">
            <div className="modal-box  ">
              ...
              <button className="btn btn-wide btn-primary w-full">Signin Now</button>
            </div>
          </dialog>
          <button className="btn btn-sm btn-primary me-4" onClick={() => document.getElementById('login').showModal()}> Login </button>
          <dialog id="login" className="modal backdrop-filter backdrop-blur-sm ">
            <div className="modal-box">
              <form method="dialog">
                {/* if there is a button in form, it will close the modal */}
                <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
